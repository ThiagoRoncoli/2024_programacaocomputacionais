...
$cat1 = new Categoria();
$cat1 = new Categoria("Bebidas");

$prod1 = new Produto(1, "Pote");
$prod2 = new Produto(2, "Balde");
$prod3 = new Produto(3, "Copo");
$prod4 = new Produto(4, "Coca-Cola 2.5L", 11, 100, $cat1);
$prod5 = new Produto(5, "Samsung M23", 1299.99, 10, new Categoria("Eletronicos"));
