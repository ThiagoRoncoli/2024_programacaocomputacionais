...
$v1-> acelerar(100);
echo "<p>Velocidade do Veículo: " . $v1 -> velocidade;

echo "<p>Velocidade do Carro: " . $c1 -> acelerar(50);

echo "<p>Velocidade do Carro: " . $c1 -> frear(10);

echo "<p>Velocidade do Carro: " . $c1 -> frear(50);
