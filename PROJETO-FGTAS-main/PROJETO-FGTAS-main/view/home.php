...
<body>
    ...
    <form class="formulario mt12-5" method="POST" action="../controller/salvarSolicitante.php?inserir">
        ...
        <fieldset class="formulario__identificacao">
            ...
            <div class="opcoesAtendimentos">
                <div class="opcaoFormulario">
                    <input value="empregador" type="radio" name="pessoasAtendimento" class="formulario__opcao" id="empregador"
                        required>
                    <label for="empregador" class="formulario__etiqueta">Empregador</label>
                </div>
                <div class="opcaoFormulario">
                    <input value="trabalhador" type="radio" name="pessoasAtendimento" id="trabalhador" class="formulario__opcao"
                        required>
                    <label for="trabalhador" class="formulario__etiqueta">Trabalhador</label>
                </div>
                <div class="opcaoFormulario">
                    <input value="ads" type="radio" name="pessoasAtendimento" id="ads" required class="formulario__opcao">
                    <label for="ads" class="formulario__etiqueta">ADS</label>
                </div>
                <div class="opcaoFormulario">
                    <input value="setores" type="radio" name="pessoasAtendimento" id="setores" required
                        class="formulario__opcao">
                    <label for="setores" class="formulario__etiqueta">Setores da FGTAS</label>
                </div>
                <div class="opcaoFormulario">
                    <input value="mercadoTrabalho" type="radio" name="pessoasAtendimento" id="mercadoTrabalho"
                ...
                <div class="opcaoFormulario">
                    <input value="outro" type="radio" name="pessoasAtendimento" class="formulario__opcao" id="outro"
                        required>
        ...
        <input name="inserir" type="submit" value="Próximo" class="formulario__botao__padrao formulario__botao mv0-5">
    <?php // var_dump($_POST); ?>
    </form>
