...
$solicitante = SolicitanteDAO::getAtendimentoByIdentificador_unico(11);
    ...
    <form method="post" class="formulario">
        <fieldset class="formulario__campo w80 mt5 centralizado">
            ...
            <section class="centralizado">
                ...
                <div>
                    <input class="formulario__entrada w90" type="text" name="nomePublico" id="nomePublico" value="<?= $solicitante->nomePublico;?>"
                        required>
                </div>
            </section>
            <section class="centralizado mv0-5">
                ...
                <div>
                    <input class="formulario__entrada w90" type="email" name="emailSolicitante" id="emailSolicitante"
                        value="<?= $solicitante->emailSolicitante;?>" required>
                </div>
            </section>
            <section class="centralizado mv0-5">
                <label class="formulario__etiqueta" for="telefoneSolicitante">Telefone</label>
                <div>
                    <input type="tel" name="telefoneSolicitante" id="telefoneSolicitante" value="<?= $solicitante->telefoneSolicitante;?>" required
            ...
            <fieldset class="sem_borda mv0-5 centralizado">
                ...
                <div>
                    <input class="formulario__opcao " type="radio" name="tipoPessoa" value="<?= $solicitante->tipo_pessoa;?>" id="fisica" required>
                    <label class="formulario__etiqueta" for="fisica">Física</label>
                </div>
                <div>
                    <input class="formulario__opcao" type="radio" name="tipoPessoa" value="<?= $solicitante->tipo_pessoa;?>" id="juridica" required>
                    <label for="juridica" class="formulario__etiqueta">Jurídica</label>
                </div>
                <div>
                    <input class="formulario__entrada w50 mv1" type="text" value="<?= $solicitante->identificador_unico;?>" name="identificadorUnico"
            ...
            <div class="centralizado">
                ...
                <div>
                    <textarea required id="descricaoAtividade" name="descricaoAtividade"
                        class="formulario__caixa__texto w90" value="<?= $solicitante->descricaoAtividade;?>"></textarea>
                </div>
            </div>
        </fieldset>
